      ...
      <section className="bg-brand-navy py-20 lg:py-24" aria-label="Chimney services hero">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl">
            {/* Breadcrumb */}
            <nav aria-label="Breadcrumb" className="mb-6 flex items-center gap-2 text-xs text-white/75">
              <Link href="/" className="hover:text-white/70 transition-colors">Home</Link>
              <span aria-hidden="true">/</span>
              <Link href="/services" className="hover:text-white/70 transition-colors">Services</Link>
              <span aria-hidden="true">/</span>
              <span className="text-white/75">Chimney Services</span>
            </nav>
            ...
            <div className="mt-9 flex flex-wrap gap-4">
              <Link
                href="/contact"
                className="inline-flex items-center gap-2 rounded-md bg-brand-orange px-6 py-3.5 text-sm font-bold text-brand-navy-dark shadow-lg shadow-brand-orange/30 transition-all hover:bg-brand-orange-hover">
                Get a Free Estimate

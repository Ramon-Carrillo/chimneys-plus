    ...
    <section
      ...
      <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
        <div className='grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-16 items-center'>
          ...
          {/* ── Left: copy — each child reveals on its own with a
              cascading delay so the section feels animated without
          ...
          <div>
            ...
            <Reveal delay={100} as='h2'>
              <span
                id='about-heading'
                className='font-heading text-3xl font-extrabold tracking-tight text-foreground sm:text-4xl block'>
                Local Expertise,{' '}
                <span className='text-brand-orange'>Built on Trust</span>
              </span>
            </Reveal>

            <Reveal delay={200} as='p' className='mt-5 text-base leading-relaxed text-muted-foreground sm:text-lg'>
            ...
            <Reveal delay={300} as='p' className='mt-4 text-base leading-relaxed text-muted-foreground sm:text-lg'>
